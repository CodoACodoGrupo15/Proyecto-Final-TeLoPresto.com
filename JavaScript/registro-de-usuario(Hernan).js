///Bloque de código para selección de municipios según provincia.
///Hasta la línea 1294
...
const provinciasYmunicipios = {
    ...
    "Corrientes": [,
        ...
        "Paso de la Patria",
        "Paso de los Libres",
        "Pedro R. Fernández / Estación Mantilla",
        "Perugorría",
        "Pueblo Libertador",
        "Ramada Paso",
        "Riachuelo",
    ...
    "La Rioja": [
        "Aimogasta /Arauco",
        "Aminga /Castro Barros",
        "Chamical",
        "Chepes /R.Vera Peñaloza",
        "Chilecito",
        "Famatina",
        "La Rioja",
        "Los Sauces /San Blas",
        "Malanzán /Gral. J.F.Quiroga",
        "Olta /Gral. Belgrano",
        "Patquía /Independencia",
        "Tama /Gral. Peñaloza",
        "Ulapes /San Martín",
        "Villa Castelli",
        "Villa San José de Vinchina",
        "Villa Sanagasta",
        "Villa Santa Rita de Catuna/ Gral Ocampo",
        "Villa Unión /Cnel. F. Varela",
    ],
    "Mendoza": [
        "General Alvear",
        "Godoy Cruz",
    ...
    "Misiones": [
        ...
        "Colonia Victoria",
        "Colonia Wanda",
        "Comandante Andrés Guacurari/Comandante Andresito",
    ...
    "San Luis": [
        ...
        "Unión",
        "Villa de Merlo",
        "Villa General Roca /Los Manantiales",
        "Villa Mercedes",
    ],
    "Santa Cruz": [
        "Caleta Olivia",
...
for (const provincia in provinciasYmunicipios) {
...
provinciaSelect.addEventListener("change", () => {
    ...
    if (selectedProvincia && provinciasYmunicipios[selectedProvincia]) {
        const municipios = provinciasYmunicipios[selectedProvincia];
